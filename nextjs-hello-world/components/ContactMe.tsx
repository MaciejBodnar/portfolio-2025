...
export const ContactMe = () => {
  ...
  const onSubmit: SubmitHandler<Inputs> = (formData) => {
    window.location.href = `mailto:bodzio4a@gmail?subject=${formData.subject}&body=Hello Maciej, my name is ${formData.name}. ${formData.message} (${formData.email})`;
  };
  ...
  return (
    <div className="h-screen flex relative flex-col text-center md:text-left xl:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
      ...
      <div className="flex flex-col space-y-4 md:space-y-10 p-0 md:p-6 justify-center">
        ...
        <div className="space-y-4 md:space-y-10">
          <div className="flex items-center space-x-2 md:space-x-5 justify-center">
            ...
            <p className="text-lg md:text-2xl">+48 799 826 302</p>
          </div>
          <div className="flex items-center space-x-2 md:space-x-5 justify-center">
            <EnvelopeIcon className="text-[#f7ab0a] h-7 w-7 animate-pulse" />
            <p className="text-lg md:text-2xl flex-wrap">
              maciej.bodnar02@gmail.com
            </p>
          </div>
          <div className="flex items-center space-x-2 md:space-x-5 justify-center">
            <MapPinIcon className="text-[#f7ab0a] h-7 w-7 animate-pulse" />
            <p className="text-lg md:text-2xl">ul. Hoza 29/31</p>
          </div>
        </div>
        ...
        >
          ...
          <button
            type="submit"
            className="bg-[#f7ab0a] py-5 px-10 rounded-md text-black font-bold text-lg hover:cursor-pointer"
          >
            Submit
          </button>
        </form>
